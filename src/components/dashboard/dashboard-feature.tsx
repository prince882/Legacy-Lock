        ...
        <div className="relative  z-10">
          ...
          <section className="px-6 py-20">
            <div className="max-w-6xl mx-auto text-center">
              ...
              <p className="text-xl  text-gray-300 max-w-3xl mx-auto mb-12 leading-relaxed">
                Ensure your crypto assets reach the right people. Add trusted beneficiaries and maintain regular check-ins
                to secure your digital inheritance.
              </p>
          ...
          <footer className="px-6 py-12 border-t border-gray-800/50">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between">
              ...
              <p className="text-gray-500 text-center md:text-right">Securing digital legacies for the future</p>
            </div>
          </footer>
        </div>
      </div>
